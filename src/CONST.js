...
const keyModifierControl = lodashGet(
  KeyCommand,
  'constants.keyModifierControl',
  'keyModifierControl',
);
const keyModifierCommand = lodashGet(
  KeyCommand,
  'constants.keyModifierCommand',
  'keyModifierCommand',
);
const keyModifierShiftControl = lodashGet(
  KeyCommand,
  'constants.keyModifierShiftControl',
  'keyModifierShiftControl',
);
const keyModifierShiftCommand = lodashGet(
  KeyCommand,
  'constants.keyModifierShiftCommand',
  'keyModifierShiftCommand',
);
const keyInputEscape = lodashGet(
  KeyCommand,
  'constants.keyInputEscape',
  'keyInputEscape',
);
const keyInputEnter = lodashGet(
  KeyCommand,
  'constants.keyInputEnter',
  'keyInputEnter',
);
const keyInputUpArrow = lodashGet(
  KeyCommand,
  'constants.keyInputUpArrow',
  'keyInputUpArrow',
);
const keyInputDownArrow = lodashGet(
  KeyCommand,
  'constants.keyInputDownArrow',
  'keyInputDownArrow',
);
...
const CONST = {
  ...
  FILE_TYPE_REGEX: {
    IMAGE:
      /\.(jpg|jpeg|png|webp|avif|gif|tiff|wbmp|ico|jng|bmp|heic|svg|svg2)$/,
    VIDEO:
      /\.(3gp|h261|h263|h264|m4s|jpgv|jpm|jpgm|mp4|mp4v|mpg4|mpeg|mpg|ogv|ogg|mov|qt|webm|flv|mkv|wmv|wav|avi|movie|f4v|avchd|mp2|mpe|mpv|m4v|swf)$/,
  },
